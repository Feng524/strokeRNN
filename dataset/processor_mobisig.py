...
mobisig_path = '/export/dev/StrokeBasedRNN/mobisig/'
processed_path = '/export/dev/StrokeBasedRNN/mobisig_processed/'
...
def main():
    ...
    data_path = '/export/dev/StrokeBasedRNN/mobisig_processed/'
    # generate_list(70, data_path, './experiments/datalist/2v1_mobisig_sample', n_v_1=2)
    generate_list(70, data_path, '/export/dev/StrokeBasedRNN/1v1_mobisig', n_v_1=1, random_fogery=True)
